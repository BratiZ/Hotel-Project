					...
					{	int tempa;
						...
						{	
							...
							for( int f2 = 0; f2 < tabBazaUslug.size(); f2++ )
							{
								...
								{
									kolor(12); cout << "\t "; 
										kolor(10); cout << "Nazwa: "; 	kolor(14); cout << tabUslugi[ tabBazaUslug[f2].getIDUsluga() ].getNazwa();
										kolor(10); cout << " Cena: "; 	kolor(14); cout << tabUslugi[ tabBazaUslug[f2].getIDUsluga() ].getCena();
										kolor(10); cout << " Ilosc: "; 	kolor(14); cout << tabBazaUslug[f2].getIlosc() << endl;	
									ileUslug += 1;
								}	
							}
